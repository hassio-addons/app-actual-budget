...
[**Report a vulnerability**](https://github.com/hassio-addons/app-actual-budget/security/advisories/new)
...
- Issues in Actual itself; please report those directly to the
  [Actual project](https://github.com/actualbudget/actual/security/policy).
...
This security policy covers the Actual Budget app in this repository: the app
